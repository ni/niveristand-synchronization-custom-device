...
<Library LVVersion="15008000">
	...
	<Item Name="System Explorer" Type="Folder">
		...
		<Item Name="SubVIs" Type="Folder">
			...
			<Item Name="Get Connection Description Text and Pins Tab.vi" Type="VI" URL="../Get Connection Description Text and Pins Tab.vi"/>
			<Item Name="Get Connection Properties.vi" Type="VI" URL="../Get Connection Properties.vi"/>
			<Item Name="Get Connection Settings.vi" Type="VI" URL="../Get Connection Settings.vi"/>
			<Item Name="Get Custom Route Properties.vi" Type="VI" URL="../Get Custom Route Properties.vi"/>
			<Item Name="Get PPS Terminal Default.vi" Type="VI" URL="../Get PPS Terminal Default.vi"/>
		...
		<Item Name="Types" Type="Folder">
			...
			<Item Name="Pins Tab.ctl" Type="VI" URL="../Pins Tab.ctl"/>
			<Item Name="Time Ref Tab.ctl" Type="VI" URL="../Time Ref Tab.ctl"/>
		</Item>
	</Item>
</Library>
