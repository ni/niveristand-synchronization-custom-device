...
<Library LVVersion="15008000">
	...
	<Item Name="Engine" Type="Folder">
		...
		<Item Name="Shut Down" Type="Folder">
			<Item Name="Clear Connections.vi" Type="VI" URL="../Clear Connections.vi"/>
			<Item Name="RT Finialize.vi" Type="VI" URL="../RT Finialize.vi"/>
			<Item Name="Tear Down Clock Discipline.vi" Type="VI" URL="../Tear Down Clock Discipline.vi"/>
		</Item>
		<Item Name="Print Error.vi" Type="VI" URL="../Print Error.vi"/>
		<Item Name="Print NIVS Debug String.vi" Type="VI" URL="../Print NIVS Debug String.vi"/>
	</Item>
	<Item Name="Types" Type="Folder">
		<Item Name="RT Data Cluster.ctl" Type="VI" URL="../RT Data Cluster.ctl"/>
		<Item Name="Timekeeper Route Pin.ctl" Type="VI" URL="../Timekeeper Route Pin.ctl"/>
		<Item Name="timekeeper type.ctl" Type="VI" URL="../timekeeper type.ctl"/>
	</Item>
	<Item Name="RT Driver VI.vi" Type="VI" URL="../RT Driver VI.vi"/>
	<Item Name="Template RT VI.vit" Type="VI" URL="../Template RT VI.vit"/>
</Library>
