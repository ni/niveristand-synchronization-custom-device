...
<Library LVVersion="11008008">
	...
	<Item Name="Shared" Type="Folder">
		<Item Name="Types" Type="Folder">
			...
			<Item Name="External Pin.ctl" Type="VI" URL="../External Pin.ctl"/>
			<Item Name="IRIG Type.ctl" Type="VI" URL="../IRIG Type.ctl"/>
			<Item Name="Mode.ctl" Type="VI" URL="../Mode.ctl"/>
			<Item Name="Route.ctl" Type="VI" URL="../Route.ctl"/>
			<Item Name="Routes.ctl" Type="VI" URL="../Routes.ctl"/>
			<Item Name="Time Ref Settings.ctl" Type="VI" URL="../Time Ref Settings.ctl"/>
			<Item Name="Time Reference.ctl" Type="VI" URL="../Time Reference.ctl"/>
		</Item>
